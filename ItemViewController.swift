...
class ItemViewController: UIViewController, UITextViewDelegate {
    ...
    // метод сохранения настроек задания на дисплее в кеш, а затем в файл
    ...
    // метод подгружвет существующуу задачу из файла для вывода на экран и проводит его настройку
    func cachedItem(){
        do
        {
